...
<nav class="navbar navbar-expand-lg" style="background-color: #3BB143 !important;">
  <div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?php echo $base_url;?>/public/donor/dashboard.php">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $base_url;?>/public/donor/sharefood.php">Share a Meal</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $base_url;?>public/donor/ngorequest.php">Pending NGO Requests</a>
        </li>
        <li class="nav-item">
